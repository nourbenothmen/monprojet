...
export class AddEditProduitModalComponent {
  ...
  @Input() produit: Produit = {
    id: undefined, // Optionnel, laissé undefined pour une nouvelle création
    name: '',
    price: 0,
    quantity: 0,
    category: '',
    quantitySold: 0, // Ajouté avec valeur par défaut
    totalSales: 0,   // Ajouté avec valeur par défaut
    lastSoldDate: '', // Ajouté avec chaîne vide (à ajuster selon vos besoins)
    version: undefined // Optionnel, laissé undefined pour une nouvelle création
  };
